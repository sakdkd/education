...
$nonExArr=getgstratesdetailbyid($conn,$buid);
...
$gstforms='';
 ...
 $disbursalterms='';
	...
	$ds=mysqli_query($conn,"SELECT * FROM `contentpages` where `type` ='1'  "); 
...
if(isset($_POST['update'])){
	...
	$insQry=mysqli_query($conn,"UPDATE `contentpages` SET  `content` = '$answer'  where `type` = '1' ");
...
<?php }?>
  ...
  <tr>
    ...
    <td width="8%">About Us Content</td>
