...
<?php }?>
            ...
            <tr>
                ...
                <?php 
				$ds=mysqli_query($conn,"SELECT * FROM `destination` order by `id` desc " ); 
...
<tr>
                ...
                <td><label style="color:#069;font-weight:bold;">Select Country</label></td>
...
var hidId=$('#hidId').val();
window.location.href='makepackages.php?id='+hidId
...
$("#continent").change(function(){
 ...
 var request = $.ajax({
  url: "../db_class/getcountrybycontinent.php",
  type: "POST",
  data: {id : menuId},
