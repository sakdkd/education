...
<?php }?>
            ...
            <tr>
				...
				?>
                <option value="<?php echo $ids ?>"><?php echo $namess; ?></option>
  ...
  <tr>
    ...
    <td colspan="2"><input type="button" name="submit"  id="submit"  value="Proceed To Start" class="btn btn-success" onClick="gotolevel()"> </td>
	...
	function gotolevel(val){
		...
		window.location.href='addsubjectandtimings.php?id='+btoa(val)
