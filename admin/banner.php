...
$imgdetail=getbannerdetails($conn,$id);
...
$img=$_FILES['image']['name'];
	...
	$insQry=mysqli_query($conn,"UPDATE `banner` SET `imagepath`='$imagepath' where`id` = '$id'");
...
if(isset($_GET['did'])){
	...
	$did=base64_decode($_GET['did']);
		...
		$insQry=mysqli_query($conn,"delete  from   `banner`  where`id` = '$did';");
...
if(isset($_POST['submit'])){
	...
	$insQry=mysqli_query($conn,"INSERT INTO `banner` (`id`,  `imagepath`) VALUES (NULL, '$imgName');");
...
<?php }?>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     <?php if( isset($_GET['eid']) && ($_GET['eid']!='')){
						...
						$categoryArr=getbannerdetails($conn,$eid);
                     
						$image=$categoryArr['imagepath']
           ...
           <tr>
                ...
                <td width="45%"><img src="../docs/<?php echo $image ?>" width="120px" height="100px"></td>
...
<tr>
  ...
  //echo "SELECT * FROM $table where `projid`='$buid' and `whichcontent`='2' order by id asc ";
    ...
    $ds=mysqli_query($conn,"SELECT * FROM `banner` order by `id` desc " ); 
	...
	if(  $numrows >0){
		...
		while($fetch=mysqli_fetch_array($ds)){
		    ...
		    <tr>
                ...
                <td><?php echo $i; ?></td>
                 <td><img src="<?php echo $baseurl;?>/docs/<?php echo $imagePath;?> " width="220px" height="100px"></td>
  ...
  <tr>
   ...
   <td align="left" style="width:30px"  ><input class='uniform' type="checkbox" id="check<?php echo $fetch['id']  ?>" value="<?php echo $fetch['status']  ?>" onClick="updateStatus('<?php echo $fetch['id'];  ?>','banner',1)" <?php if($fetch['status']==1){echo 'checked';} ?>></td>
