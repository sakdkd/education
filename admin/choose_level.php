...
<?php }?>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     <form action="" id="choose_level"  method="Post"  onSubmit="return validate()" enctype="multipart/form-data"> 
            ...
            <tr>
                ...
                <td ><select  name="level" id="level" class="form-control" onChange="showsubjects(this.value)"   >
