...
if(isset($_POST['update'])){
	...
	$insQry=mysqli_query($conn,"UPDATE `qfeature` SET  `name` = '$name'  where`id` = '$id'");
...
if(isset($_GET['did'])){
	...
	$did=base64_decode($_GET['did']);
		...
		$insQry=mysqli_query($conn,"Update   `qfeature` set `view`='0'  where`id` = '$did';");
...
if(isset($_POST['submit'])){
	...
	$insQry=mysqli_query($conn,"INSERT INTO `qfeature` (`id`,   `name`) VALUES (NULL,   '$name');");
...
function validate(){
	...
	if(name==''){
		...
		alert("Please enter qfeature name ");
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     <?php if( isset($_GET['eid']) && ($_GET['eid']!='')){
						...
						$categoryArr=getTableDetailsById($conn,'qfeature',$eid);
                     ...
                     <form action=""  method="Post" enctype="multipart/form-data" id="qfeatures"> 
...
<table class="table table-responsive table-bordered" id="ls-editable-table">
  ...
  <tr>
   ...
   <td align="left" style="width:30px"  ><input class='uniform' type="checkbox" id="check<?php echo $fetch['id']  ?>" value="<?php echo $fetch['status']  ?>" onClick="updateStatus('<?php echo $fetch['id'];  ?>','qfeature',2)" <?php if($fetch['status']==1){echo 'checked';} ?>></td>
