...
<?php }?>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action=""  method="Post" id="question_forms2" enctype="multipart/form-data"> 
...
$date=$fetch['pdate'];			
  ...
  <tr>
   ...
   <td align="left" style="width:30px"  ><input class='uniform' type="checkbox" id="check<?php echo $fetch['id']  ?>" value="<?php echo $fetch['status']  ?>" onClick="updateStatus('<?php echo $fetch['id'];  ?>','packages',8)" <?php if($fetch['status']==1){echo 'checked';} ?>></td>
