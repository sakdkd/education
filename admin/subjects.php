...
if(isset($_POST['update'])){
	...
	$insQry=mysqli_query($conn,"UPDATE `subjects` SET  `name` = '$name' , `timebound`='$timebound'  ,`promptbased`='$promptbased' where`id` = '$id'");
...
if(isset($_GET['did'])){
	...
	$did=base64_decode($_GET['did']);
		...
		$insQry=mysqli_query($conn,"Update   `subjects` set `view`='0'  where`id` = '$did';");
...
$selquery=mysqli_query($conn,"select * from `subjects` where `name`='$name' and `status`='1' and `view`='1'");
$numr=mysqli_num_rows($selquery);
if($numr==0)
{
	$insQry=mysqli_query($conn,"INSERT INTO `subjects` (`id`,  `timebound`, `name`,`promptbased`) VALUES (NULL,  '$timebound', '$name','$promptbased');");
...
else
{
		...
		header("location:".$page."?msg=exist");
...
if(isset($_GET['msg'])){
	...
	case 'exist':
		...
		$msgText="Content already exists";
...
<?php }?>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     <?php if( isset($_GET['eid']) && ($_GET['eid']!='')){
						...
						$categoryArr=getTableDetailsById($conn,'subjects',$eid);
            ...
            <tr>
                ...
                <td><label style="color:#069;font-weight:bold;">Subject Name</label></td>
...
<tr>
                ...
                <td><label style="color:#069;font-weight:bold;">Time Bound</label></td>

                <td width="28%"><table width="100%" border="0">
  <tr>
    <td><input type="radio" name="timebound" value="1" <?php if($categoryArr['timebound']==1){ ?> checked <?php }?>></td>
    <td>Yes</td>
   <td><input type="radio" name="timebound" value="0" <?php if($categoryArr['timebound']==0){ ?> checked <?php }?>></td>
    <td>No</td>
  </tr>
</table>
</td>
            ...
            <tr>
                ...
                <td><label style="color:#069;font-weight:bold;">Prompt Based</label></td>

                <td width="28%"><table width="100%" border="0">
  <tr>
    <td><input type="radio" name="promptbased" value="1" <?php if($categoryArr['promptbased']==1){ ?> checked <?php }?>></td>
    <td>Yes</td>
   <td><input type="radio" name="promptbased" value="0" <?php if($categoryArr['promptbased']==0){ ?> checked <?php }?>></td>
    <td>No</td>
  </tr>
</table></td>
...
<tr>
                ...
                <td width="38%"><table width="100%" border="0" class="table table-striped table-bordered">
  <tr>
    <td><input type="radio" name="timebound" value="1" checked></td>
    <td>Yes</td>
   <td><input type="radio" name="timebound" value="0"></td>
    <td>No</td>
  </tr>
</table>
</td>
            ...
            <tr>
                ...
                <td width="38%"><table width="100%" border="0" class="table table-striped table-bordered">
  <tr>
    <td><input type="radio" name="promptbased" value="1"></td>
    <td>Yes</td>
   <td><input type="radio" name="promptbased" value="0" checked></td>
    <td>No</td>
  </tr>
</table></td>
  ...
  <tr>
            ...
            <th width="3%">Sno</th>
             ...
             <th width="30%"> Name</th>
                <th width="12%" style="text-align:center;">Time Bound</th>
                   <th width="12%" style="text-align:center;">Prompt Based</th>
  ...
  //echo "SELECT * FROM $table where `projid`='$buid' and `whichcontent`='2' order by id asc ";
	...
	if(  $numrows >0){
		...
		while($fetch=mysqli_fetch_array($ds)){
			...
			$name=$fetch['name'];
			$timebound=$fetch['timebound'];
			$promptbased=$fetch['promptbased'];
		    ...
		    <tr>
                ...
                <td style="text-align:center;"><?php echo getYesNoByValue($conn, $timebound); ?></td>
                <td style="text-align:center;"><?php echo getYesNoByValue($conn,$promptbased); ?></td>
  ...
  <tr>
   ...
   <td align="left" style="width:30px"  ><input class='uniform' type="checkbox" id="check<?php echo $fetch['id']  ?>" value="<?php echo $fetch['status']  ?>" onClick="updateStatus('<?php echo $fetch['id'];  ?>','subjects',3)" <?php if($fetch['status']==1){echo 'checked';} ?>></td>
