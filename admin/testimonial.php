...
$title="User Experience Image Based Management";
...
$img=$_FILES['image']['name'];
		$pdate=date("Y-m-d");
			 ...
			 $moveimg=move_uploaded_file($imagenamesrc,'../docs/'.$imgName);
...
$img=$_FILES['image']['name'];
	...
	$insQry=mysqli_query($conn,"INSERT INTO `testimonial` (`id`, `place`, `testimonial`, `name`,`imagepath`,`postedby`,`posteddate`,`status`) VALUES (NULL, '$place', '$description', '$name','imgName','$buid','$pdate','$status');");
...
<tr>
            ...
            <tr>
                ...
                <td><label style="color:#069;font-weight:bold;">Update Experience</label></td>

                <td width="28%" colspan="2"><textarea style="height:100px;" name="description" id="description" class="form-control"  value="" ><?php echo htmlentities(stripslashes($categoryArr['testimonial'])) ?> </textarea></td>
...
<tr>
            ...
            <tr>
                ...
                <td><label style="color:#069;font-weight:bold;">Add Experience *</label></td>

                <td width="28%" colspan="2"><textarea type="text" name="description" style="height:100px;" id="description" class="form-control"  value=""   ></textarea></td>
...
<tr>
  ...
  //echo "SELECT * FROM $table where `projid`='$buid' and `whichcontent`='2' order by id asc ";
    ...
    $ds=mysqli_query($conn,"SELECT * FROM `testimonial` where `postedby`='$buid' order by `id` desc " ); 
	...
	if(  $numrows >0){
		...
		while($fetch=mysqli_fetch_array($ds)){
		    ...
		    <tr>
                ...
                <td><img src="<?php echo $baseurl;?>/docs/<?php echo $fetch['imagepath'];?> "></td>
