...
<?php }?>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     <form action="" id="choose_subview"  method="Post"  onSubmit="" enctype="multipart/form-data"> 
...
<input type="hidden" value="" name="hiddenvalue" id="hiddenvalue">
  ...
  <tr>
    ...
    <td colspan="2"><input type="submit" name="submit"  id="submit"  value="Proceed" class="btn btn-success"> </td>
