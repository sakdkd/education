...
<div class="topic-font"><span><?php echo $ques_count;?> question(s)</span><a href="<?php echo $page_name;?>?id=<?php echo base64_encode($ids);?>"><button class="btn btn-primary">View Questions</button></a></div> 
