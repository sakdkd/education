...
$tbname="orders";
 ...
 $order_id=$oid;
 $order_details=$tab_details=getTableDetailsById($conn,$table,$oid);
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-p15b" align="center">
                                                                                        <a target="_blank"> <img src="img/fav/favicon.png" alt="Beretun logo" style="display: block;" title="Beretun logo" width="37"> </a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
