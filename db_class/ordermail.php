...
function OrderMail($conn,$oid,$baseurl)
{ 
$tbname="orders";

 $order_id=$oid;
 $order_details=$tab_details=getTableDetailsById($conn,$tbname,$oid);
$address=$order_details['address'];
$state=getTableDetailsById($conn,"location",$order_details['state']);
$cn=getTableDetailsById($conn,"country",$order_details['country']);
$country=$order_details['city'].",".$state['name'].",".$cn['name'];
$postal=$order_details['postal'];
$package_arr=getBoughtPackagefromOid($conn,$order_id);
  $orderID=getOrderCode($conn,$oid);
...
<body>
    <div class="es-wrapper-color">
                    ...
                    <td class="esd-email-paddings" valign="top">
                        ...
                        <table class="es-content" cellspacing="0" cellpadding="0" align="center">
                            <tbody>
                                ...
                                <img src="http://78.46.117.226/education/img/logo.png" alt="logo">    
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p10b es-p10r es-p10l" align="left">
                                                                                        <table style="width: 500px;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left">
                                                                                            <tbody>';
			$subtotal=0;																				
		foreach($package_arr as $planid)
		{	
									$edupricing_details=getTableDetailsById($conn,"edu_pricing",$planid);
									
									$subtotal+=$edupricing_details['price'];
     ...
     <a target="_blank"> <img src="'.$baseurl.'/img/fav/favicon.png" alt="" style="display: block;" title="Beretun logo" width="37"> </a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
