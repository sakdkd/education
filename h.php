...
$tbname="orders";
$id='1';
$email="sakshi@dkd.co.in";
		echo $message=newpasswordlink($email,$id,$baseurl); die;

//resetpasslink($conn,$id,$baseurl,$pass); die;	
?>
<!DOCTYPE html>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="xeronav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item drop_menu"> <a class="nav-link active" href="#">Dashboard</a>
                       
                    </li>
                    <li class="nav-item drop_menu"> <a class="nav-link" href="#">Prep Plan</a>
                        
                    </li>
                    <li class="nav-item drop_menu"> <a class="nav-link" href="#">Practice Excercise</a></li>
