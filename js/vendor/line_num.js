...
Skip to content
Using DoubleKlick Designs Mail with screen readers
...
---------- Forwarded message ---------
From: Sumit Kumar <sumit@dkd.co.in>
Date: Tue, Nov 26, 2019 at 4:58 PM
Subject:
To: Sagar Saxena <sagar@dkd.co.in>
...
if (typeof define === 'function' && define.amd) {
  ...
  $.fn.extend({
    ...
    linenum : function (options){
      ...
      //update line numbers when window resize
      $(window).on('resize',function(){
        lineElem.height(thisContents.height());
      });
      return {
        newElem:newElem,
