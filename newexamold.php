...
-->
			 ...
			 for($i=1;$i<=$mainActiveques;$i++)
				   ...
				   ?>
                       ...
                       <li class=" page-item nav nav-pills <?php echo $added_class_new;?>" id="li<?php echo $i;?>"><a href="#Q<?php echo $i;?>" data-toggle="tab"><?php echo $i;?></a></li>
                       <?php }?>
                   </ul>
               </div>
           </div>
...
<div class="gray-bg pt-20 pb-50">
        <div class="container">
            <div class="container"><div class="next-prev-question d-flex justify-content-end">
                    ...
                    <button type="button" class="btn btn-success" onclick="questionvisibility(2)" id="">Next Question</button>
                    <input type="hidden" name="question_value" id="question_value" value="1">
                </div> </div>  
                
             <input type="hidden" name="btnclickval" value="1" id="btnclickval">
		...
		$user_ans=$user_attmpted_ques['answer'];
			...
			?> 
           <div class="row tab-content clearfix tab-pane fade <?php echo $added_class;?>" id="Q<?php echo $q_div;?>" role="tabpanel" >
               <div class="col-md-12">
                  <div class="card question-side">
                   <div class="row " id="">
                       <div class="col-md-8">
                           <div class="qustion-box">
                             <p><?php echo $questionset['question'];?></p>
                       ...
                       <ul>
                           <li><input name="radio1" id="Q<?php echo $question_id;?>1" type="radio" value="1" class="" onclick="setanswer('1','<?php echo $question_id;?>')" <?php if($user_ans==1){?> checked <?php }?>><span class="check"><?php echo $questionset['option1'];?></span></li>
                            <li><input name="radio1" id="Q<?php echo $question_id;?>2" type="radio" value="2" onclick="setanswer('2','<?php echo $question_id;?>')"  <?php if($user_ans==2){?> checked <?php }?>><span class="check"><?php echo $questionset['option2'];?></span></li>
                            <li><input name="radio1" id="Q<?php echo $question_id;?>3" type="radio" value="3" onclick="setanswer('3','<?php echo $question_id;?>')"  <?php if($user_ans==3){?> checked <?php }?>><span class="check"><?php echo $questionset['option3'];?></span></li>
                            <li><input name="radio1" id="Q<?php echo $question_id;?>4" type="radio" value="4" onclick="setanswer('4','<?php echo $question_id;?>')"  <?php if($user_ans==4){?> checked <?php }?>><span class="check"><?php echo $questionset['option4'];?></span></li>
                       </ul>
    ...
    <input name="levelids" id="" type="hidden" value="<?php echo $levelids;?>">
      ...
      <?php 
			...
			?>  
             ...
             <input name="ans<?php echo $question_ids;?>" id="Ans<?php echo $question_ids;?>" type="hidden" value="">     
<?php }}?>   
   </form> 
   <?php }?>
