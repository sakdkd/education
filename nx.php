            ...
            <div class="col-md-3">
                <div class="time-wrapper">
                    ...
                    <div class="time-button">
                        <button class="btn"><i class="fa fa-pause" style="font-size: 12px"></i> Pause Section</button>
                        <button class="btn" type="submit" name="submit"><i class="fa fa fa-stop" style="font-size: 12px"></i> End Section</button>
                    </div>
                </div>
            </div>
        </div>
           ...
           <div class="container">
			 ...
			 for($i=1;$i<=$question_total;$i++)
				   ...
				   ?>
                       ...
                       <li class=" page-item nav nav-pills <?php echo $added_class_new;?>"><a href="#Q<?php echo $i;?>" data-toggle="tab"><?php echo $i;?></a></li>
                       <?php }?>
                   </ul>
               </div>
           </div>
...
<div class="gray-bg pt-20 pb-50">
        <div class="container">
            <div class="container"><div class="next-prev-question d-flex justify-content-end">
                    ...
                    <button class="btn btn-success" onclick="questionvisibility(2)" type="button" id="">Next Question</button>
                    <input type="text" name="question_value" id="question_value" value="1">
                </div> </div>  
                       ...
                       <ul>
                           <li><input name="radio1" id="Q<?php echo $question_id;?>1" type="radio" value="1" class="" onclick="setanswer('1','<?php echo $question_id;?>')"><span class="check"><?php echo $questionset['option1'];?></span></li>
                            ...
                            <li><input name="radio1" id="Q<?php echo $question_id;?>4" type="radio" value="4" onclick="setanswer('4','<?php echo $question_id;?>')"><span class="check"><?php echo $questionset['option4'];?></span></li>
                                   ...
                                   <input name="option<?php echo $q_div;?>" id="option<?php echo $q_div;?>" type="text" value="<?php echo $question_id;?>">    
    ...
    <input name="levelids" id="" type="hidden" value="<?php echo $levelids;?>">
      ...
      <?php 
			...
			?>  
             ...
             <input name="ans<?php echo $question_ids;?>" id="Ans<?php echo $question_ids;?>" type="text" value="">     
<?php }}?>   
   </form> 
