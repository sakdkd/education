 		...
 		<div class="row">
 			<div class="col-md-8 col-md-offset-2 customer1">
				...
				{?>
 				...
 				<a href="practice_action.php?pause=2"><input type="submit" class="end-section" value="Exit Section" name="submit"></a>
 			</div>
            <?php } else{?>
            <div class="col-md-5">
             				<a href="practice_action.php?end=1"><input type="submit" class="end-section" value="End Section" name="submit"></a>

 			</div>
            <?php }?>
 			 <div class="col-md-5">
 				<a href="practice_action.php?pause=1"><button type="button" class="end-section-gray">Return To Section</button></a>
 			</div>
 			 <div class="col-md-1"></div>
