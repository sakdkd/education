...
.answer-gray-bg .roundedOne label {
  ...
  .wrapper-title h1{font-size: 30px; font-weight: 500;} 
    .wrapper-title {
    padding: 26px 30px;
}    
ul#myTabs1 {
                          ...
                          <div class="tab  ">
                               <a href="#"><p class="small">SUMMARY</p>
                                   <p>Test <br>Overview</p></a>
                                              ...
                                              <div class="col-md-2">
                           <div class="tab tabing-new ">
                               <a href="result_summery.php?id=OQ==&amp;test=2"><p class="small">Start</p>
                                   <p>1 Verbal Reasoning</p></a>
                           </div>
                       </div>
                       
                                              <div class="col-md-2">
                           <div class="tab tabing-new ">
                               <a href="result_summery.php?id=MTA=&amp;test=2"><p class="small">Start</p>
                                   <p>2 Quantitative Reasoning</p></a>
                           </div>
                       </div>
                       
                                              <div class="col-md-2">
                           <div class="tab tabing-new ">
                               <a href="result_summery.php?id=MTE=&amp;test=2"><p class="small">Start</p>
                                   <p>3 Reading Comprehension</p></a>
                           </div>
                       </div>
                       
                                              <div class="col-md-2">
                           <div class="tab tabing-new active">
                               <a href="result_summery.php?id=MTI=&amp;test=2"><p class="small">Completed</p>
                                   <p>4 Mathematics Achievement</p></a>
                           </div>
                       </div>
                       
                                              <div class="col-md-2">
                           <div class="tab tabing-new ">
                               <a href="result_summery.php?id=MTM=&amp;test=2"><p class="small">Start</p>
                                   <p>5 Essay</p></a>
                           </div>
                       </div>
              ...
              <div class="row justify-content-between qfilterwrapper">
                  <div class="col-md-5 text-left">
                      <div class="qfilter d-flex align-items-center">
                          ...
                          <select id="questionFilter"  class="form-control ng-pristine ng-untouched ng-valid"><option value="0" label="--">--</option><option value="1" label="Correct">Correct</option><option value="2" label="Incorrect">Incorrect</option><option value="3" label="Omitted">Omitted</option><option value="4" label="Flagged">Flagged</option><option value="5" label="Timing: less than 30 sec">Timing: less than 30 sec</option><option value="6" label="Timing: 30 sec to 2 min">Timing: 30 sec to 2 min</option><option value="7" label="Timing: greater than 2 min">Timing: greater than 2 min</option><option value="8" label="Difficulty: Easy">Difficulty: Easy</option><option value="9" label="Difficulty: Medium">Difficulty: Medium</option><option value="10" label="Difficulty: Hard">Difficulty: Hard</option><option value="11" label="Type: Synonyms">Type: Synonyms</option><option value="12" selected="selected" label="Type: Sentence Completion">Type: Sentence Completion</option><option value="13" label="Type: Two-Blank Sentence Completion">Type: Two-Blank Sentence Completion</option></select>
                      </div>
                  </div>
...
-->
        ...
        <div class="container"> 
            <div class=""><div class="next-prev-question d-flex justify-content-end">
